      ...
      <div className=\"max-w-7xl mx-auto px-4 md:px-8 py-8\">
        ...
        {loading ? (
          ...
          <div className=\"text-center py-12 bg-white rounded-2xl border border-border/50\">
            ...
            <Button onClick={() => setShowDialog(true)} className=\"bg-primary hover:bg-primary/90 text-white rounded-full\">
              <Plus className=\"w-4 h-4 mr-2\" />
              Add Product
            </Button>
          </div>
                ...
                <div className=\"p-6\">
                  <div className=\"mb-2\">
                    ...
                    {product.discount_percentage > 0 && (
                      <span className=\"inline-block text-xs bg-accent text-white px-2 py-1 rounded-full mb-2\">
                  ...
                  <div className=\"mb-3\">
                    ...
                    <div className=\"text-xl font-bold text-primary\">₹{product.sale_price}</div>
                  </div>
              ...
              <div className=\"space-y-2 mt-2\">
                {formData.bulk_pricing.map((bulk, idx) => (
                  <div key={idx} className=\"flex gap-2\">
                    ...
                    />
                    <Button type=\"button\" variant=\"ghost\" onClick={() => removeBulkPricing(idx)}>
                      Remove
                    </Button>
                  </div>
                ))}
                <Button type=\"button\" variant=\"outline\" onClick={addBulkPricing} className=\"w-full\">
